...
public class WorldCup {
    public static int teamNum=17;
    public static double[][] win=new double[teamNum][teamNum];
    public static double get1Win(int n)
    {
        int mate[]={0,0,0,0,0,0,0,0};
        switch ((n-1)/8)
        {
            case 0:
            {
        ...
        double w=get2Win(n);
        double[] matewin=new double[8];
        double w1=0;
        for(int i=0;i<8;i++)
        {
            matewin[i]=get2Win(mate[i]);
            w1+=matewin[i]*win[n][mate[i]];
        }
        return w1*w;
    }
    public static double get2Win(int n)
    {
        int mate[]={0,0,0,0};
        switch ((n-1)/4)
        {
        ...
        double w=get4win(n);
        double[] matewin=new double[4];
        double w2=0;
        for(int i=0;i<4;i++)
        {
            matewin[i]=get4win(mate[i]);
            w2+=matewin[i]*win[n][mate[i]];
        }
        return w2*w;

    }
    public static double get4win(int n)
    {
        int mate[]={0,0};
        if(((n-1)/2)%2==0)
        {
        ...
        double w=get8win(n);
        double[] matewin=new double[2];
        matewin[0]=get8win(mate[0]);
        matewin[1]=get8win(mate[1]);
        return w*(matewin[0]*win[n][mate[0]]+matewin[1]*win[n][mate[1]]);
    }
    public static double get8win(int n)
    {
        return n%2==0?win[n][n-1]:win[n][n+1];
    }
